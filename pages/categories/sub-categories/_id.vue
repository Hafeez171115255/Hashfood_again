<template>
  <div>
    <BreadCrumbs :routes="routes" :active_route="'Sub Category Name'" />
...
export default {
  ...
  methods: {
    ...
    async sortProduct() {
      ...
      const res = await this.callApi(
        "get",
        `/api/product/sub-/${this.$route.params.id}?
  ...
  async asyncData({ app, query, params }) {
    ...
    let url = `/api/product/sub-category/${params.id}?
